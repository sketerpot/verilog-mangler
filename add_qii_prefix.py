...
def mangleName(identifier):
    '''Take a Verilog identifier and add QII_ to the beginning'''
...
Puts a QII_ prefix in front of all module names declared in the
input-file. Warning: uses global search-and-replace and does not
